...
#
# Generated by export_simulation on Fri Nov 04 13:34:36 -0600 2022
#
################################################################################
...
'-reset_run' switch to the './vgaCLKgen.sh' script.

./vgaCLKgen.sh -reset_run
...
./vgaCLKgen.sh -noclean_files

For more information on the script, please type './vgaCLKgen.sh -help'.
