...
#
# Generated by export_simulation on Fri Nov 04 13:39:17 -0600 2022
#
################################################################################
...
'-reset_run' switch to the './imageMemory.sh' script.

./imageMemory.sh -reset_run
...
./imageMemory.sh -noclean_files

For more information on the script, please type './imageMemory.sh -help'.
