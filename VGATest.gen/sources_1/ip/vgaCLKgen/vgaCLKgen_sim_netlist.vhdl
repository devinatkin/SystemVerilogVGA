...
--               c:/Users/devin/VGATest/VGATest.gen/sources_1/ip/vgaCLKgen/vgaCLKgen_sim_netlist.vhdl
-- Design      : vgaCLKgen
...
entity vgaCLKgen_vgaCLKgen_clk_wiz is
  port (
  ...
  attribute ORIG_REF_NAME of vgaCLKgen_vgaCLKgen_clk_wiz : entity is "vgaCLKgen_clk_wiz";
end vgaCLKgen_vgaCLKgen_clk_wiz;

architecture STRUCTURE of vgaCLKgen_vgaCLKgen_clk_wiz is
  signal clk_out100_vgaCLKgen : STD_LOGIC;
  signal clk_out100_vgaCLKgen_en_clk : STD_LOGIC;
  signal clk_out1_vgaCLKgen : STD_LOGIC;
  signal clk_out1_vgaCLKgen_en_clk : STD_LOGIC;
  signal clk_vgaCLKgen : STD_LOGIC;
  signal clkfbout_buf_vgaCLKgen : STD_LOGIC;
  signal clkfbout_vgaCLKgen : STD_LOGIC;
...
clkf_buf: unisim.vcomponents.BUFG
     port map (
      I => clkfbout_vgaCLKgen,
      O => clkfbout_buf_vgaCLKgen
    );
...
clkout1_buf_en: unisim.vcomponents.BUFH
     port map (
      I => clk_out1_vgaCLKgen,
      O => clk_out1_vgaCLKgen_en_clk
    );
...
clkout2_buf_en: unisim.vcomponents.BUFH
     port map (
      I => clk_out100_vgaCLKgen,
      O => clk_out100_vgaCLKgen_en_clk
    );
mmcm_adv_inst: unisim.vcomponents.MMCME2_ADV
    generic map(
      ...
      STARTUP_WAIT => false
        ...
        port map (
      CLKFBIN => clkfbout_buf_vgaCLKgen,
      CLKFBOUT => clkfbout_vgaCLKgen,
      CLKFBOUTB => NLW_mmcm_adv_inst_CLKFBOUTB_UNCONNECTED,
      CLKFBSTOPPED => NLW_mmcm_adv_inst_CLKFBSTOPPED_UNCONNECTED,
      CLKIN1 => clk_vgaCLKgen,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcm_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_out1_vgaCLKgen,
      CLKOUT0B => NLW_mmcm_adv_inst_CLKOUT0B_UNCONNECTED,
      CLKOUT1 => clk_out100_vgaCLKgen,
...
entity vgaCLKgen is
  ...
  attribute NotValidForBitStream of vgaCLKgen : entity is true;
end vgaCLKgen;

architecture STRUCTURE of vgaCLKgen is
begin
inst: entity work.vgaCLKgen_vgaCLKgen_clk_wiz
     port map (
      clk => clk,
      clk_out1 => clk_out1,
