...
################################################################
# This is a generated script based on design: MicroB
#
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set inputs [ create_bd_port -dir I -from 31 -to 0 inputs ]
  set outputs [ create_bd_port -dir O -from 31 -to 0 outputs ]
  ...
  # Create port connections
  connect_bd_net -net axi_gpio_0_gpio2_io_o [get_bd_ports outputs] [get_bd_pins axi_gpio_0/gpio2_io_o]
  connect_bd_net -net clk_wiz_1_locked [get_bd_pins clk_wiz_1/locked] [get_bd_pins rst_clk_wiz_1_100M/dcm_locked]
  connect_bd_net -net inputs_1 [get_bd_ports inputs] [get_bd_pins axi_gpio_0/gpio_io_i]
