...
HD_PWD='C:/Users/devin/VGATest/VGATest.runs/image_memory_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log image_memory.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source image_memory.tcl
