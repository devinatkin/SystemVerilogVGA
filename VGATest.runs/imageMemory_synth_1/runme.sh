...
HD_PWD='C:/Users/devin/VGATest/VGATest.runs/imageMemory_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log imageMemory.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source imageMemory.tcl
