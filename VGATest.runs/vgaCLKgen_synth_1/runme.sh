...
HD_PWD='C:/Users/devin/VGATest/VGATest.runs/vgaCLKgen_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vgaCLKgen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vgaCLKgen.tcl
