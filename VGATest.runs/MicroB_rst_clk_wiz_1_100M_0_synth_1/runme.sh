...
HD_PWD='C:/Users/devin/VGATest/VGATest.runs/MicroB_rst_clk_wiz_1_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MicroB_rst_clk_wiz_1_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MicroB_rst_clk_wiz_1_100M_0.tcl
