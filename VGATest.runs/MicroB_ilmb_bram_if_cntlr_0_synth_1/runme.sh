...
HD_PWD='C:/Users/devin/VGATest/VGATest.runs/MicroB_ilmb_bram_if_cntlr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MicroB_ilmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MicroB_ilmb_bram_if_cntlr_0.tcl
