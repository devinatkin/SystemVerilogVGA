...
HD_PWD='C:/Users/devin/VGATest/VGATest.runs/MicroB_microblaze_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MicroB_microblaze_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MicroB_microblaze_0_0.tcl
